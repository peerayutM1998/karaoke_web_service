...
<body>
    ...
    <a href="edit_promo.php?id=<?php echo $row['promo_id']; ?>" class="btn btn-sm btn-warning">แก้ไข</a>
    <a href="manage_promotions.php?delete_id=<?php echo $row['promo_id']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('ยืนยันการลบโปรโมชั่น?');">ลบ</a>
</td>
                                </tr>
                                <?php endwhile; ?>
                            </tbody>
